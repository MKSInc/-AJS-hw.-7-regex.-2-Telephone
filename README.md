[![Build status](https://ci.appveyor.com/api/projects/status/s9y5cf81wyekwxov?svg=true)](https://ci.appveyor.com/project/MKSInc/ajs-hw-7-regex-2-telephone)
...
## 7.2 Телефоны (задача со звёздочкой)
